          ...
          <div className="kanban-column" key={group}>
            <div className="kanban-column-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', marginLeft: '10px' }}>
                {renderIcon(group)}
                <span style={{ marginLeft: '8px' }}>{group}  {groupedTickets[group].length}</span>
              </div>
              {/* Icons on the right side with added margin */}
              <div style={{ display: 'flex', alignItems: 'center', marginRight: '16px' }}> {/* Adjust marginRight as needed */}
                {/* New SVG Icon */}
                <svg
                  style={{ marginLeft: '40px', marginRight: '8px' }} // Adjust marginRight for spacing
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  fill="none"
            ...
            <KanbanGroup groupTitle={group} tickets={groupedTickets[group]} grouping={grouping} />
          </div>
        ))}
      </div>
    </div>
